...
export class AboutUs implements IPage {
  ...
  private init(): void {
    ...
    const rsLink = createElement('div', { class: 'aboutus__akateam' });
    rsLink.innerHTML = `Project was created as a part of studying in <a class="aboutus__rsslogo" target="_blank" href="https://rs.school/js/">${AboutUs.rssLogo}</a>`;
    this.container.append(aboutUsHeader, akaTeam, rsLink, aboutUsSection);
